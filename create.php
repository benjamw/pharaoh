...
// $Id: create.php 217 2009-11-19 07:40:38Z cchristensen $
	...
	<script type="text/javascript">//<![CDATA[
		$(document).ready( function( ) {
			$("#show_conquer_limit_table").fancybox({
				...
				padding : 10,
				overlayOpacity : 0.7,
				callbackOnStart : build_conquer_table
			});
			...
			$("#show_custom_trades_table").fancybox({
				...
				padding : 10,
				overlayOpacity : 0.7,
				callbackOnStart : build_custom_trades_table
			});
		});
	/*]]>*/</script>
';
		...
		<div>
			...
			<fieldset>
				...
				<div id="conquer_limits">
					...
					<br /><br />
					<div><label for="conquer_minimum">Minimum</label><input type="text" id="conquer_minimum" name="conquer_minimum" size="4" /> (Default: 0)</div>
			...
			<div><input type="submit" name="create" value="Create Game" /></div>
		</div>
